class Car {
    ...
    refresh() {
        ...
        if (this.used) {
            document.querySelector('#player-car').style = `top: ${this.positionY}px; left: ${this.positionX}px; transform: rotate(${this.direction}deg);`;
        }
        //document.querySelector('.player-car').style = `top: 350px; left: 100px; transform: rotate(80deg);`;
    }
